...
%else
%global excluded_reqs python-zunclient muranoclient senlinclient tackerclient vitrageclient
%endif
...
%else
%global excluded_brs doc8 bandit pre-commit hacking flake8-import-order coverage unittest2 muranoclient senlinclient tackerclient vitrageclient
%endif
